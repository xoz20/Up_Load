...
ALTER TABLE SANPHAM
ADD CONSTRAINT DVT CHECK(DVT ='cay' or DVT='hop' or DVT ='cai' or DVT='quyen'or DVT='chuc')
...
SELECT MASP,TENSP
FROM SANPHAM
WHERE MASP LIKE'B%01' --BC01, BB01--
...
SELECT MASP, TENSP
FROM SANPHAM
WHERE NUOCSX='Trung Quoc' AND GIA>30000 AND GIA < 40000 or NUOCSX='Thai Lan' AND GIA>30000 AND GIA < 40000
...
SELECT SOHD,TRIGIA
FROM HOADON
WHERE NGHD>='1/1/2007' AND NGHD<='30/1/2007'
ORDER BY NGHD ASC

-- Giảm dần --
SELECT SOHD,TRIGIA
FROM HOADON
WHERE MONTH(NGHD)=1  AND YEAR(NGHD)=1
ORDER BY NGHD DESC
